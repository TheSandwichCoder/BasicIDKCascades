...
def get_confidence_thresholds():
    ...
    print(get_model_conf_threshold(cc1, DESIRED_PRECISION, loader))


    m2 = get_resnet_34()
    cc2 = CascadeClassifier(m2)

    print(get_model_conf_threshold(cc2, DESIRED_PRECISION, loader))

    m3 = get_resnet_152()
    cc3 = CascadeClassifier(m3)

    print(get_model_conf_threshold(cc3, DESIRED_PRECISION, loader))
...
def benchmark():
    ...
    bench_classifier(cc1, loader)
    bench_classifier(cc2, loader)
    bench_classifier(cc3, loader)
    bench_classifier(cascade, loader)
